...
namespace SolutionSecrets2022.Options.AzureKeyVault
{
	partial class AzureKeyVaultUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Default Key Vault URL";
			// 
			...
			this.txtDefaultKeyVaultUrl.Location = new System.Drawing.Point(8, 31);
			this.txtDefaultKeyVaultUrl.Name = "txtDefaultKeyVaultUrl";
			this.txtDefaultKeyVaultUrl.Size = new System.Drawing.Size(779, 31);
			...
			this.Controls.Add(this.txtDefaultKeyVaultUrl);
			this.Controls.Add(this.label1);
			this.Name = "AzureKeyVaultUserControl";
			this.Size = new System.Drawing.Size(803, 545);
